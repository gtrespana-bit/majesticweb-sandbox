...
export default function HomePage() {
  const services = [
    { icon: <Globe className="w-7 h-7" />, title: "Diseño Web Premium", description: "Sitios web únicos que capturan la esencia de tu marca." },
    { icon: <Zap className="w-7 h-7" />, title: "Experiencias 3D", description: "Tecnología Spline para mundos interactivos." },
    { icon: <Rocket className="w-7 h-7" />, title: "SEO & Performance", description: "Velocidad extrema y posicionamiento orgánico." },
    { icon: <Users className="w-7 h-7" />, title: "Soporte Premium", description: "Acompañamiento 24/7 para escalar tu proyecto." }
  ]
  ...
  return (
    <>
      ...
      <section className="py-24 relative z-10">
        <div className="container mx-auto px-4 text-center mb-12">
          <Badge className="mb-4 bg-green-500/20 text-green-400 border-green-500/30">Testimonios</Badge>
          <h2 className="text-3xl md:text-5xl font-bold text-[hsl(var(--fg))]">Lo que Dicen <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-emerald-400">Nuestros Clientes</span></h2>
        </div>
